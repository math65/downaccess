...
4. Dans cette fenêtre, naviguez normalement sur le site et **lancez la lecture de la vidéo ou de l'audio**. C'est le déclenchement de la lecture qui révèle le fichier média. Les boutons **Précédent**, **Suivant** et **Actualiser**, à côté du champ Adresse dans la fenêtre DownAccess, pilotent la page. Les raccourcis **Alt+Flèche gauche**, **Alt+Flèche droite** et **F5** font la même chose, et fonctionnent aussi bien depuis la fenêtre DownAccess que depuis la fenêtre de navigation elle-même : vous n'avez pas à changer de fenêtre pour revenir en arrière.
