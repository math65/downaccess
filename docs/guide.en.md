...
4. In that window, browse the site normally and **start playing the video or audio**. It's the act of starting playback that reveals the media file. The **Back**, **Forward** and **Reload** buttons, next to the Address field in the DownAccess window, drive the page. The **Alt+Left**, **Alt+Right** and **F5** shortcuts do the same, and work from the DownAccess window as well as from the browsing window itself: you do not have to switch windows to go back.
